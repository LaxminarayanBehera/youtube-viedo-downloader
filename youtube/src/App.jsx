    ...
    <div className="h-500 w-1000 bg-[radial-gradient(circle_at_bottom_left,_var(--tw-gradient-stops))] from-red-700 via-red-600 to-red-700">
      ...
      <div className="flex items-center justify-center gap-x-2">
        <input
          ...
          value={URL}
        />
        <button className="bg-black text-white h-10 px-3 rounded-3xl font-semibold hover:bg-white hover:text-black hover:font-bold" onClick={downloadViedo}>
          Download
        </button>
      </div>
